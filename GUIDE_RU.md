...
- [Гайд по установке Svelte.](#гайд-по-установке-svelte.)
  ...
  - [Установка](#установка)
    ...
    - [Установка Svelte](#установка-svelte)
      - [Опционально: Tailwind CSS](#опоционально-tailwind-css)
  ...
  - [Разработка](#разработка)
    ...
    - [Директивы `bind`, `on`](#директивы-`bind`,-`on`)
      ...
      - [Обработчики событий `on`](#обработчики-событий-`on`)
...
_Не забудьте добавить `<slot />` в `/src/pages/restTest/_layout.svelte`. Либо можно просто не создавать его._
